...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#121212] grid md:grid-cols-2">
      {/* Left Column - Content */}
      <div className="flex flex-col items-start justify-center p-0 md:p-16">
      ...
      <div className="hidden md:flex items-center justify-center bg-[#CDEA68] relative">
        <img
          src={"https://firebasestorage.googleapis.com/v0/b/newprojecta-36c09.appspot.com/o/iMockup%20-%20iPhone%2015%20Pro%20Max-1.png?alt=media&token=060a25f0-cc84-4960-987b-b3bc03605a4a"}
          alt="App preview"

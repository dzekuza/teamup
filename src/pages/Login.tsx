    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-md mx-auto">
        <div className="bg-[#1E1E1E] rounded-3xl p-8">
          <h1 className="text-2xl font-medium text-white mb-6 text-center">Login</h1>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-white text-gray-800 rounded-xl py-3 font-medium hover:bg-gray-100 transition-colors"
            disabled={isLoading}
          >
          ...
          <div className="mt-6 text-center text-gray-400">
            ...
            <Link to="/register" className="text-[#C1FF2F] hover:underline">
              Register
            </Link>
          </div>
        </div>

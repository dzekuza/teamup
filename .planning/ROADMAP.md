...
- [x] **Phase 1: Auth Provider Wiring + Auth Page Migration** - Wire SupabaseAuthProvider at app root and migrate Login/Register to Supabase auth (completed 2026-02-23)
